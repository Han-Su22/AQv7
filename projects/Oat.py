...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Oat' # Full name of a crop
    crop_name_short = 'oat' # Crop's code name from GGCMI
    crop_fao = 75 # Crop's code from FAO
    ...
    crop_gaez=['Oat']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.49
    LAI_CC_c=1
