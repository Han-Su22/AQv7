...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Soy' # Full name of a crop
    crop_name_short = 'soy' # Crop's code name from GGCMI
    crop_fao = 236 # Crop's code from FAO
    ...
    crop_name_4code='soyb'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Soybean']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1.005
    LAI_CC_b=-0.6
    LAI_CC_c=1.2
