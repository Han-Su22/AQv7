...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Vegetables' # Full name of a crop
    crop_name_short = 'veg' # Crop's code name from GGCMI
    crop_fao = 463 # Crop's code from FAO
    ...
    crop_gaez=['Tomato']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.736
    LAI_CC_c=1.
