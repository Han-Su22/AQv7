...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Sunflower' # Full name of a crop
    crop_name_short = 'sun' # Crop's code name from GGCMI
    crop_fao = 267 # Crop's code from FAO
    ...
    crop_name_4code='sunf'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Sunflower']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.82
    LAI_CC_c=1
