...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Cotton' # Full name of a crop
    crop_name_short = 'cot' # Crop's code name for variables
    crop_fao = 328 # Crop's code from FAO
    ...
    crop_name_4code='cott'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Cotton']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.77
    LAI_CC_c=1
