...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Cowpea' # Full name of a crop
    crop_name_short = 'cwp' # Crop's code name from GGCMI
    crop_fao = 195 # Crop's code from FAO
    ...
    crop_name_4code='cowp'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Cowpea']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.7133
    LAI_CC_c=1
