...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Millet' # Full name of a crop
    crop_name_short = 'mil' # Crop's code name from GGCMI
    crop_fao = 79 # Crop's code from FAO
    ...
    crop_name_4code='pmil'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Millet','Pearl millet']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.49
    LAI_CC_c=1
