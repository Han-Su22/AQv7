...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Onion' # Full name of a crop
    crop_name_short = 'oni' # Crop's code name from GGCMI
    crop_fao = 403 # Crop's code from FAO
    ...
    irr_thresholds = [75]*4 # % of TAW when to trigger irrigation events
    ...
    crop_gaez=['Onion']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.471
    LAI_CC_c=1
