...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Pea' # Full name of a crop
    crop_name_short = 'pea' # Crop's code name from GGCMI
    crop_fao = 187 # Crop's code from FAO
    ...
    crop_name_4code='opul'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Dry pea']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.76
    LAI_CC_c=1
