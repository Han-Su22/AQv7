...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Olive' # Full name of a crop
    crop_name_short = 'oli' # Crop's code name from GGCMI
    crop_fao = 260 # Crop's code from FAO
    ...
    crop_gaez=['Olive']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.575
    LAI_CC_c=1
