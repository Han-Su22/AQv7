...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Spring Wheat' # Full name of a crop
    crop_name_short = 'swh' # Crop's code name from GGCMI
    ...
    crop_gaez=['Spring wheat','Wheat']#only useful for soil fertility calibration
