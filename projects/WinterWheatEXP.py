...
class project_conf:
    # General
    project_name = "WinterWheatEXP"
    crop_model = 'AquaCrop' # Only this one available for now
    ...
    # Crop settings
    crop_name = 'Winter Wheat' # Full name of a crop
    crop_name_short = 'wwh' # Crop's code name from GGCMI
    crop_fao = 15 # Crop's code from FAO
    ...
    crop_name_4code='whea'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Winter wheat','Wheat']#only useful for soil fertility calibration
