...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Apple' # Full name of a crop
    crop_name_short = 'apl' # Crop's code name from GGCMI
    crop_fao = 515 # Crop's code from FAO
    ...
    crop_gaez=['Citrus']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.6
    LAI_CC_c=1.
