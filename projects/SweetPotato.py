...
class project_conf:
    ...
    # Crop settings
    crop_name = 'SweetPotato' # Full name of a crop
    crop_name_short = 'spt' # Crop's code name from GGCMI
    crop_fao = 122 # Crop's code from FAO
    ...
    crop_name_4code='swpo'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Sweet potato']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.8275
    LAI_CC_c=1
