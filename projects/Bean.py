...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Bean' # Full name of a crop
    crop_name_short = 'bea' # Crop's code name from GGCMI
    crop_fao = 176 # Crop's code from FAO
    ...
    crop_name_4code='bean'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Phaseolus bean']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.84
    LAI_CC_c=1
