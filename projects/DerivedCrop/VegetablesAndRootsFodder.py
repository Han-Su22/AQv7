...
class project_conf:
    # General
    crop_name = 'VegetablesAndRootsFodder' # Full name of a crop
    crop_name_short = 'vrf' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4]  # Scenarios to consider
    crop_fao = 655 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 463 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'veg' # Corresponding generic crop's code name (3-letter format)
