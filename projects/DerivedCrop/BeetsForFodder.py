...
class project_conf:
    # General
    crop_name = 'BeetsForFodder' # Full name of a crop
    crop_name_short = 'btf' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4]  # Scenarios to consider
    crop_fao = 647 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 157 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'sgb' # Corresponding generic crop's code name (3-letter format)
