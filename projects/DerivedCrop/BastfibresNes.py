...
class project_conf:
    # General
    crop_name = 'BastfibresNes' # Full name of a crop
    crop_name_short = 'btn' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4,5]  # Scenarios to consider
    crop_fao = 782 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 187 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'pea' # Corresponding generic crop's code name (3-letter format)
    ...
    crop_name_4code='ofib'#SPAM crop
