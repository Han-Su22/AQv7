...
class project_conf:
    # General
    crop_name = 'ForageMaize' # Full name of a crop
    crop_name_short = 'mzf' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4]  # Scenarios to consider
    crop_fao = 636 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 56 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'mai' # Corresponding generic crop's code name (3-letter format)
