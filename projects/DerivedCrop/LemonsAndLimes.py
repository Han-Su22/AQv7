...
class project_conf:
    # General
    crop_name = 'LemonsAndLimes' # Full name of a crop
    crop_name_short = 'lme' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4,5]  # Scenarios to consider
    crop_fao = 497 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 490 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'ora' # Corresponding generic crop's code name (3-letter format)
    ...
    crop_name_4code='trof'#SPAM crop
