...
class project_conf:
    # General
    crop_name = 'SugarCrops' # Full name of a crop
    crop_name_short = 'scn' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4]  # Scenarios to consider
    crop_fao = 161 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 156 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'sgc' # Corresponding generic crop's code name (3-letter format)
