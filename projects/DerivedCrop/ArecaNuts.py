...
class project_conf:
    # General
    crop_name = 'ArecaNuts' # Full name of a crop
    crop_name_short = 'arn' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4,5]  # Scenarios to consider
    crop_fao = 226 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 249 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'cnt' # Corresponding generic crop's code name (3-letter format)
