...
class project_conf:
    # General
    crop_name = 'Sisal' # Full name of a crop
    crop_name_short = 'sis' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4,5]  # Scenarios to consider
    crop_fao = 789 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 821 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'fbn' # Corresponding generic crop's code name (3-letter format)
