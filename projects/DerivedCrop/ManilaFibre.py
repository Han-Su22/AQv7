...
class project_conf:
    # General
    crop_name = 'ManilaFibre' # Full name of a crop
    crop_name_short = 'mnf' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4,5]  # Scenarios to consider
    crop_fao = 809 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 486 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'bnn' # Corresponding generic crop's code name (3-letter format)
