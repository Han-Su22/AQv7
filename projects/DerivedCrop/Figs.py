...
class project_conf:
    # General
    crop_name = 'Figs' # Full name of a crop
    crop_name_short = 'fig' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4,5]  # Scenarios to consider
    crop_fao = 569 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 560 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'grp' # Corresponding generic crop's code name (3-letter format)
