...
class project_conf:
    # General
    crop_name = 'CarrotsForForage' # Full name of a crop
    crop_name_short = 'ctf' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4]  # Scenarios to consider
    crop_fao = 648 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 10001 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'vgt' # Corresponding generic crop's code name (3-letter format)
