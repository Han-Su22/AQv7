...
class project_conf:
    # General
    crop_name = 'Mangoes' # Full name of a crop
    crop_name_short = 'mng' # Crop's code name (3-letter format)
    scenarios = [1,2,3,4,5]  # Scenarios to consider
    crop_fao = 571 # FAO crop code 
    
    # Deriving from
    cor_gen_crop_fao = 603 # Corresponding generic FAO crop code 
    cor_gen_crop_name_short = 'ftn' # Corresponding generic crop's code name (3-letter format)
