...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Rubber' # Full name of a crop
    crop_name_short = 'rub' # Crop's code name from GGCMI
    crop_fao = 836 # Crop's code from FAO
    ...
    crop_gaez=['Para rubber']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.59#broadleaf forest 
    LAI_CC_c=1.
