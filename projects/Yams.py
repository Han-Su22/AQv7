...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Yams' # Full name of a crop
    crop_name_short = 'yam' # Crop's code name from GGCMI
    crop_fao = 137 # Crop's code from FAO
    ...
    crop_name_4code='yams'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Yam','Yellow yam','White yam','Greater yam','Cocoyam']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.5943
    LAI_CC_c=1
