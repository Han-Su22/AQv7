...
class project_conf:
    ...
    # Crop settings
    crop_name = 'PigeonPea' # Full name of a crop
    crop_name_short = 'pgp' # Crop's code name from GGCMI
    crop_fao = 197 # Crop's code from FAO
    ...
    crop_name_4code='pige'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Pigeonpea']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.7
    LAI_CC_c=1
