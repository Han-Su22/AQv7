...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Lentils' # Full name of a crop
    crop_name_short = 'lnt' # Crop's code name from GGCMI
    crop_fao = 201 # Crop's code from FAO
    ...
    crop_name_4code='lent'#SPAM crop
