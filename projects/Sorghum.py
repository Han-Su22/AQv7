...
class project_conf:
    ...
    # Crop settings
    crop_name = 'Sorghum' # Full name of a crop
    crop_name_short = 'sor' # Crop's code name for variables
    crop_fao = 83 # Crop's code from FAO
    ...
    crop_name_4code='sorg'#SPAM crop
    #C:\Users\SuH\OneDrive - Universiteit Twente\WaterResearch\AquaCrop\GAEZ\Crop_table.xlsx
    crop_gaez=['Biomass highland sorghum','Biomass lowland sorghum','Biomass sorghum',
               'Biomass temperate sorghum','Highland sorghum','Lowland sorghum',
               'Sorghum','Temperate sorghum']#only useful for soil fertility calibration
    #a*(1-np.exp(b*LAI))**c
    LAI_CC_a=1
    LAI_CC_b=-0.48
    LAI_CC_c=1
