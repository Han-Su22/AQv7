...
project1 = 'Rice1'
project2 = 'Rice2'
gs_mask_ = r"D:\ACEA_v2_2\data\acea\harvested_areas\27\ri1_ir_ggcmi_crop_calendar_phase3_v1.01.nc4"
climate_name = 'gswp3-w5e5_obsclim/gswp3-w5e5_obsclim_01-01-1981_31-12-2019'
crop_name = 'Rice'
gs_to_consider = 5; first_year = 2008
new_crop_name = 'ric'

gs_mask =  ac.ReadNC(gs_mask_, 'fraction_of_harvested_area')
gs_mask = np.ones((gs_to_consider, 360, 720)) * gs_mask


new_folder = r'D:\ACEA_v2_2\outputs\Rice'
